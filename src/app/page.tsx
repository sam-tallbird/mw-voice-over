...
export default function Home() {
  ...
  return (
    <div>
      <div className="h-[20rem] w-full bg-white flex flex-col items-center justify-center relative pt-32">
        <GradientText
          colors={["#660AF0", "#1DB6FD", "#45FC79"]}
          animationSpeed={8}
          showBorder={false}
          className="text-7xl font-bold text-center whitespace-nowrap relative z-20"
        >

          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gray-50 border-b border-gray-200">
                <th className="text-left py-12 px-6 font-semibold text-gray-900 w-1/4"></th>
                {plans.map((plan, index) => (
                  <th key={index} className="text-center py-12 px-4 font-semibold text-gray-900 relative w-1/4">
              ...
              {comparisonFeatures.map((category, categoryIndex) => (
                <React.Fragment key={`category-${categoryIndex}`}>
                  <tr className="bg-gray-50">
                    <td colSpan={4} className="py-4 px-6 font-semibold text-gray-900 text-lg border-t border-gray-200">
                      {category.category}
                    </td>
                  </tr>
